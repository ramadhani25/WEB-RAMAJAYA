...
$d = DB::query('SELECT * FROM barang WHERE id_jenis_brg=1 ORDER BY nama_brg');
            ...
            <div class="row">
                    ...
                    <div class="category">
                        ...
                        <ul>
                            <?php foreach ($d2 as $data) { ?>
                                <li><a class="<?php if($data['nama_alt'] == 'herbisida') { echo 'active';} ?>" href="<?php echo $data['nama_alt'] . '.php'?> "><?php echo $data['nama_jenis_brg'] ?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
                <div class="col-12 d-block d-md-none category-list">
                    <ul class="d-flex flex-wrap justify-content-center">
                        <?php foreach ($d2 as $data) { ?>
                            <li class="py-3 px-3"><a class="<?php if($data['nama_alt'] == 'herbisida') { echo 'active';} ?>" href="<?php echo $data['nama_alt'] . '.php'?> "><?php echo $data['nama_jenis_brg'] ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
